...
def _vfx_summary(args) -> None:
    ...
    names = (
        ...
        "niagara_stateless_emitters",
        "niagara_stateless_modules",
        "niagara_stateless_renderers",
        "niagara_data_channels",
        "niagara_data_channel_variables",
        "niagara_parameter_collections",
        "niagara_parameter_collection_parameters",
        "cascade_systems",
        "cascade_emitters",
        "cascade_lods",
        "cascade_modules",
